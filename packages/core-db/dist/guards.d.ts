 ...
 */
export declare class WriteGuardError extends Error {
 ...
 * ```
 */
export declare function validateTenantWrite(context: Partial<TenantWriteContext>): asserts context is TenantWriteContext;
/**
 ...
 * ```
 */
export declare function validatePlatformWrite(context: Partial<PlatformWriteContext>): asserts context is PlatformWriteContext;
/**
 ...
 */
export declare function ensureTenantId(tenantId: string | null | undefined): asserts tenantId is string;
/**
 ...
 */
export declare function ensureActorUserId(actorUserId: string | null | undefined): asserts actorUserId is string;
