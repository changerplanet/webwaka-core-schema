 ...
 * ```
 */
export declare function createAuditLog(tx: TransactionClient, data: AuditLogData): Promise<void>;
/**
 ...
 */
export declare function auditCreate(tx: TransactionClient, entityType: string, entityId: string, actorUserId: string, tenantId: string | null | undefined, data: Record<string, any>, metadata?: Record<string, any>): Promise<void>;
/**
 ...
 * @param metadata - Optional additional metadata
 */
export declare function auditUpdate(tx: TransactionClient, entityType: string, entityId: string, actorUserId: string, tenantId: string | null | undefined, changes: Record<string, any>, metadata?: Record<string, any>): Promise<void>;
/**
 ...
 * @param metadata - Optional additional metadata
 */
export declare function auditDelete(tx: TransactionClient, entityType: string, entityId: string, actorUserId: string, tenantId: string | null | undefined, snapshot?: Record<string, any>, metadata?: Record<string, any>): Promise<void>;
/**
 * Check if currently writing an audit log
 * Used to prevent recursive audit logging
 */
export declare function isAuditInProgress(): boolean;
